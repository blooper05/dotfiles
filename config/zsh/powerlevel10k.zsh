# Generated by Powerlevel10k configuration wizard on 2021-06-04 at 18:09 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 21229.
# Wizard options: nerdfont-complete + powerline, large icons, unicode, lean, 24h time,
# 2 lines, dotted, right frame, dark-ornaments, sparse, many icons, fluent,
